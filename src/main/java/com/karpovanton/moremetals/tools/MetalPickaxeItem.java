...
/**
 * A base class for all metal pickaxes
 */
public class MetalPickaxeItem extends PickaxeItem {
     ...
     * @param parent Parent metal settings
     */
    public MetalPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, MetalSettings parent) {
        super(material, attackDamage, attackSpeed, new Item.Settings().group(ItemGroupRegistry.TOOLS));

        _profile = new MetalProfile(parent, 0, 0);
    }
