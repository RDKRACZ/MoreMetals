...
/**
 * A base class for all metal swords
 */
public class MetalSwordItem extends SwordItem {
    ...
    /**
     * Item constructor
     * @param toolMaterial Tool material
     * @param attackDamage Attack damage
     * @param attackSpeed Attack speed
     * @param settings Metal settings
     */
    public MetalSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, MetalSettings settings) {
        super(toolMaterial, attackDamage, attackSpeed, new Item.Settings().group(ItemGroupRegistry.TOOLS));
